// accountId, username, password, firstName, lastName, balance, accountType;
...
(123456, 'johndoe@email.com', 'f1ction', 'John', 'Doe', 8400.00, 'checking'),
(123457, 'johndoe@email.com', 'f1ction', 'John', 'Doe', 5000.00, 'savings');

CREATE TABLE transactions (
    transaction_uuid PRIMARY KEY NOT NULL,
